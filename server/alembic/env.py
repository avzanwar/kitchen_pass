...
The database URL comes from application settings (KP_DATABASE_URL) rather than
alembic.ini, so migrations always run against the same database the app does.
"""
